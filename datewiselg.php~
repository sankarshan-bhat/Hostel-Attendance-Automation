...
if(!$_POST['sdate'] || !$_POST['edate'])
{
	...
	echo"<p style='color:blue;font:30px bold arial;'>you did not copleted all the required fields"."<br /></p>";
...
$result=mysql_query("SELECT USN ,Name,room_no,block  FROM student WHERE USN IN(SELECT USN FROM finalattendance WHERE value='2' AND Date>='$sdate' AND Date<='$edate')");
$count=mysql_num_rows($result);

if($count==0)
{

echo"No lg student found";
}
