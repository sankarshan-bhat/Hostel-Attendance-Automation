...
$result=mysql_query("SELECT USN ,Name,room_no,block  FROM student WHERE USN IN(SELECT USN FROM finalattendance WHERE value='2' AND Date='$date')");
$count=mysql_num_rows($result);

if($count==0)
{

echo"No lg for this day is found";
