...
$result=mysql_query("SELECT USN ,Name,room_no,block  FROM student WHERE USN IN(SELECT USN FROM finalattendance WHERE value='0' AND Date>='$sdate' AND Date<='$edate')");
